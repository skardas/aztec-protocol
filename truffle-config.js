...
function createProvider(network) {
    ...
    let privateKeys = ["todo"];

    if (network === 'paritest'){
        return new HDWalletProvider(
            {
                privateKeys: privateKeys,
                providerOrUrl: "wss://rpc.testnet.paribuscan.com",
                chainId: 3500,
            }
        );
    }
...
switch (process.env.MODE) {
    ...
    default:
        ...
        pariTestProvider = createProvider('paritest');
        break;
}
...
module.exports = {
    ...
    networks: {
        ...
        paritest: {
            provider: pariTestProvider,
            gas: 5500000,
            gasPrice: toHex(toWei('18', 'gwei')),
            network_id: '3500',
            confirmations: 2,
            skipDryRun: true,
        },
